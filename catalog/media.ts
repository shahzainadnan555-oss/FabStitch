...
export const MEDIA_BY_FABRIC_SLUG: Record<string, FabricMedia> = {
  ...
  "french-terry-lightweight": {
    status: "final",
    src: "/media/fabrics/french-terry-lightweight-primary.webp",
  ...
  "french-terry-organic": {
    status: "final",
    src: "/media/fabrics/french-terry-organic-primary.webp",
    alt: "Organic cotton French terry with a looped back",
  },
  "french-terry-modal": {
    status: "final",
    src: "/media/fabrics/french-terry-modal-primary.webp",
    alt: "Modal French terry with a soft looped back",
  },
  "french-terry-stretch": {
    status: "final",
    src: "/media/fabrics/french-terry-stretch-primary.webp",
    alt: "Stretch French terry with a looped knit back",
  },
  "french-terry-slub": {
    status: "final",
    src: "/media/fabrics/french-terry-slub-primary.webp",
    alt: "Slub French terry with irregular yarn texture",
  },
  "french-terry-loopback": {
    status: "final",
    src: "/media/fabrics/french-terry-loopback-primary.webp",
    alt: "French terry showing its looped knit back",
  },
  "french-terry-heavyweight": {
    status: "final",
    src: "/media/fabrics/french-terry-heavyweight-primary.webp",
    alt: "Heavyweight French terry with a dense looped back",
  },
  "french-terry-recycled-cotton": {
    status: "final",
    src: "/media/fabrics/french-terry-recycled-cotton-primary.webp",
    alt: "Recycled-cotton French terry with a looped back",
  },
  "french-terry-peached": {
    status: "final",
    src: "/media/fabrics/french-terry-peached-primary.webp",
    alt: "Peached French terry with a softened face",
  },
  "ponte-rayon-nylon": {
    status: "final",
    src: "/media/fabrics/ponte-rayon-nylon-primary.webp",
    alt: "Rayon-nylon ponte with a smooth stable face",
  },
  "ponte-cotton-rayon": {
    status: "final",
    src: "/media/fabrics/ponte-cotton-rayon-primary.webp",
    alt: "Cotton-rayon ponte with a smooth double-knit face",
  },
  "ponte-double-knit": {
    status: "final",
    src: "/media/fabrics/ponte-double-knit-primary.webp",
    alt: "Ponte double knit with a stable matte face",
  },
  "ponte-compact": {
    status: "final",
    src: "/media/fabrics/ponte-compact-primary.webp",
    alt: "Compact ponte knit with a stable double-knit face",
  },
  "ponte-brushed": {
    status: "final",
    src: "/media/fabrics/ponte-brushed-primary.webp",
    alt: "Brushed ponte double knit with a softened face",
  },
  "ponte-structured": {
    status: "final",
    src: "/media/fabrics/ponte-structured-primary.webp",
    alt: "Structured ponte knit with a firm double-knit body",
  },
  "ponte-lightweight": {
    status: "final",
    src: "/media/fabrics/ponte-lightweight-primary.webp",
    alt: "Lightweight ponte knit with a fine stable face",
  },
  "ponte-matte": {
    status: "final",
    src: "/media/fabrics/ponte-matte-primary.webp",
    alt: "Matte ponte knit with a smooth double-knit face",
  },
  "ponte-ribbed": {
    status: "final",
    src: "/media/fabrics/ponte-ribbed-primary.webp",
    alt: "Ribbed ponte knit with a fine vertical texture",
  },
  "ponte-travel": {
    status: "final",
    src: "/media/fabrics/ponte-travel-primary.webp",
    alt: "Travel ponte knit with a smooth stable face",
  },
  "tencel-plain-weave": {
    status: "final",
    src: "/media/fabrics/tencel-plain-weave-primary.webp",
    alt: "Tencel plain weave with an even cloth surface",
  },
  "tencel-twill": {
    status: "final",
    src: "/media/fabrics/tencel-twill-primary.webp",
    alt: "Tencel twill with a clear diagonal weave",
  },
  "tencel-denim": {
    status: "final",
    src: "/media/fabrics/tencel-denim-primary.webp",
    alt: "Tencel denim with a twill face",
  },
  "tencel-shirting": {
    status: "final",
    src: "/media/fabrics/tencel-shirting-primary.webp",
    alt: "Tencel shirting cloth with a fine woven surface",
  },
  "tencel-jersey": {
    status: "final",
    src: "/media/fabrics/tencel-jersey-primary.webp",
    alt: "Tencel jersey with a fine knit surface",
  },
  "tencel-heavy-twill": {
    status: "final",
    src: "/media/fabrics/tencel-heavy-twill-primary.webp",
    alt: "Heavy Tencel twill with a pronounced diagonal",
  },
  "tencel-linen-blend": {
    status: "final",
    src: "/media/fabrics/tencel-linen-blend-primary.webp",
    alt: "Tencel and linen blend with a natural woven texture",
  },
  "tencel-sateen": {
    status: "final",
    src: "/media/fabrics/tencel-sateen-primary.webp",
    alt: "Tencel sateen with a smooth lustrous face",
  },
  "tencel-brushed": {
    status: "final",
    src: "/media/fabrics/tencel-brushed-primary.webp",
    alt: "Brushed Tencel fabric with a softened surface",
  },
  "tencel-cotton-poplin": {
    status: "final",
    src: "/media/fabrics/tencel-cotton-poplin-primary.webp",
    alt: "Tencel and cotton poplin with a smooth plain weave",
  },
  "wool-cotton-twill": {
    status: "final",
    src: "/media/fabrics/wool-cotton-twill-primary.webp",
    alt: "Wool-cotton twill with a fine diagonal weave",
  },
  "wool-linen-tailoring-open-weave": {
    status: "final",
    src: "/media/fabrics/wool-linen-tailoring-open-weave-primary.webp",
    alt: "Open-weave wool and linen tailoring cloth",
  },
  "wool-silk-suiting": {
    status: "final",
    src: "/media/fabrics/wool-silk-suiting-primary.webp",
    alt: "Wool and silk suiting with a fine woven face",
  },
  "wool-viscose-twill": {
    status: "final",
    src: "/media/fabrics/wool-viscose-twill-primary.webp",
    alt: "Wool-viscose twill with a clear diagonal weave",
  },
  "wool-polyester-suiting": {
    status: "final",
    src: "/media/fabrics/wool-polyester-suiting-primary.webp",
    alt: "Wool-polyester suiting with a smooth tailored face",
  },
  "wool-polyamide-crepe": {
    status: "final",
    src: "/media/fabrics/wool-polyamide-crepe-primary.webp",
    alt: "Wool-polyamide crepe with a fine pebbled weave",
  },
  "wool-cashmere-melton": {
    status: "final",
    src: "/media/fabrics/wool-cashmere-melton-primary.webp",
    alt: "Wool-cashmere melton with a dense felted face",
  },
  "wool-mohair-fresco": {
    status: "final",
    src: "/media/fabrics/wool-mohair-fresco-primary.webp",
    alt: "Wool-mohair fresco with an airy woven surface",
  },
  "wool-alpaca-brushed": {
    status: "final",
    src: "/media/fabrics/wool-alpaca-brushed-primary.webp",
    alt: "Brushed wool-alpaca cloth with a soft raised nap",
  },
  "wool-hemp-canvas": {
    status: "final",
    src: "/media/fabrics/wool-hemp-canvas-primary.webp",
